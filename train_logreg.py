...
if __name__ == "__main__":
    ...
    model = LogisticRegression(vocab.embedding_dim, 1)
    ...
    print(f'\tLogistic Regression - Overall Precision: {overall_metrics["precision"]:.2f}')
    print(f'\tLogistic Regression - Overall Recall: {overall_metrics["recall"]:.2f}')
    print(f'\tLogistic Regression - Overall F1-Score: {overall_metrics["f1-score"]:.2f}\n')
